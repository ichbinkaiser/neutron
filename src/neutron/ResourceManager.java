...
final class ResourceManager
{
	...
	public void loadBitmaps()
	{
		...
		for (int bitmapindex = 0; bitmapindex < buzzballbitmaps.length; bitmapindex++)
		{
			...
			centerX = BitmapFactory.decodeResource(context.getResources(), drawables[bitmapindex]).getWidth() / 2;
			centerY = BitmapFactory.decodeResource(context.getResources(), drawables[bitmapindex]).getHeight() / 2;

			source = BitmapFactory.decodeResource(context.getResources(), drawables[bitmapindex]);
			source_width = BitmapFactory.decodeResource(context.getResources(), drawables[bitmapindex]).getWidth();
			source_height = BitmapFactory.decodeResource(context.getResources(), drawables[bitmapindex]).getHeight();
